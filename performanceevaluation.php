...
<html lang="en">
  ...
  <head>
   ...
   <title><?php echo TITLE; ?></title> 
    ...
    <?php srcInit(VIEWS . '/performanceevaluation/scss/style.css'); ?>
  </head>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <!-- Begin Page Content -->
            ...
            <?php include_once('views/performanceevaluation/perfeval.php')?>
  		    </div>
          <!-- /.container-fluid -->
        </div>
        <!-- End of Main Content -->
  ...
  <?php srcInit(VIEWS . '/performanceevaluation/perfeval.js'); ?>
