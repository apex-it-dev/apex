...
;( function() {
    ...
    Tree.prototype = {
         ...
         */
        /**
         **: removed to workaround height of div: abacare
        ...
        */
        handleOverflow: function( treeWidth, treeHeight ) {
            ...
            // Custom abacare
            if(treeWidth <= this.drawArea.clientWidth){
                this.drawArea.style.overflowX = "";
                this.drawArea.style.overflowY = "";
                // this.drawArea.width = treeWidth;
            }
            // ------------
            this._R.setSize( viewWidth, viewHeight );
