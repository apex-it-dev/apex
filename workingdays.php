...
<html lang="en">
  ...
  <head>
   ...
   <title><?php echo TITLE; ?></title> 
    ...
    <?php srcInit(VIEWS . '/workingday/scss/style.css'); ?>
  </head>
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <!-- Begin Page Content -->
            ...
            <?php include_once('views/workingday/workingday.php')?>
  		    </div>
          <!-- /.container-fluid -->
        </div>
        <!-- End of Main Content -->
    ...
    <?php srcInit(VIEWS . '/workingday/workingday.js'); ?>
